...
import {AppState, NativeModules, Platform, requireNativeComponent, TextInput, TextInputProps,} from 'react-native';
...
const InputCalculator: React.FC<InputCalculatorProps> = (props) => {
    ...
    useEffect(() => {
        ...
        if (props.selectionState && props.selection) {
...
// @ts-ignore
const RCTInputCalculator = requireNativeComponent(
    'RCTInputCalculator',
    InputCalculator,
    {}
);
